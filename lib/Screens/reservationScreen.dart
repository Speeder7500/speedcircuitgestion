      ...
      body: isLoading
          ...
          : SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  _buildTableSection(
                    title: 'Tourtes les réservations',
                    icon: Icons.list_alt,
                  ...
                  _buildTableSection(
                    ...
                    emptyMessage: 'Aucune réservations pour aurjourd\'hui.',
                  ),
                  SizedBox(height: 24),
                  _buildTableSection(
                    ...
                    emptyMessage: 'Aucune réservations passées.',
                  ),
                ],
              ),
            ),
                ...
                rows: reservations.asMap().entries.map((entry) {
                  ...
                  return DataRow(
                    ...
                    cells: [
                      ...
                      DataCell(
                        Text(
                          '${res.heure.day.toString().padLeft(2, '0')}/'
                          '${res.heure.month.toString().padLeft(2, '0')}/'
                          '${res.heure.year}',
                        ),
                      ),
                      DataCell(
                        Text(
                          '${res.heure.hour.toString().padLeft(2, '0')}:'
                          '${res.heure.minute.toString().padLeft(2, '0')}',
                        ),
                      ),
